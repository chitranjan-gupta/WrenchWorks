        ...
        <div className="bg-white">
            ...
            >
              <div className="flex lg:flex-1">
                <div className="h-8 w-8">
                  <Image priority={true} alt="logo" src={logo} width={50} height={50} />
                </div>
          ...
          <div className="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div className="w-full flex flex-row -ml-8 mainheader justify-between">
              <div>
                <Image priority={true} alt="" src={car} width={500} height={700} />
              </div>
      ...
      >
        <div className="container">
          ...
          <div className="flex flex-wrap -mx-4">
            {posts.map((post) => (
              <div key={post.id} className="w-full md:w-1/2 lg:w-1/3 px-4">
