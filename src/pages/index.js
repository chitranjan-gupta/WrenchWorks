    ...
    >
      ...
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        <div className="mx-auto h-28 w-52 p-1">
          <Image width={200} height={200} src={piping} alt="Testimonial logo" />
        </div>
        <figure className="mt-10">
          <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
            <p>
              “The blog section on this website is a treasure trove of valuable
              information for car enthusiasts like me. I love reading their
              articles on car features, maintenance tips, and industry insights.
              The content is well-researched, engaging, and keeps me updated
              with the latest happenings in the automotive world.”
            </p>
          </blockquote>
