    ...
    <div className=" p-5">
      ...
      <div className="flex flex-col justify-between">
        ...
        <div className="flex flex-col justify-center ">
          ...
          website, interact with our content, or fill out forms on our site. The
          ...
          <ul className="list-disc list-inside ml-3">
            <li className="flex flex-col justify-center">
              ...
              you voluntarily provide when submitting forms or communicating
              with us.
            </li>
            <li className="flex flex-col justify-center">
              ...
              address, browser type and version, pages you visit, time and date
              of your visit, and other statistics.This information helps us
          ...
          <div className="flex flex-col justify-center">
            ...
            <ul className="list-disc list-inside ml-3">
              ...
              <li className="flex flex-col justify-center">
                ...
                with users, such as providing requested services or products, we
          ...
          <div className="flex flex-col justify-center ">
            <span className="text-xl pspan">Use of Personal Information: </span>
            ...
            <ul className="list-disc list-inside ml-3">
              ...
              <li className="flex flex-col justify-center">
                <span className="text-lg pspan">To send periodic emails:</span>
                ...
                our website. You can always opt-out of receiving these emails by
          ...
          <div className="flex flex-col justify-center ">
            ...
            relevant ads based on your browsing history and interests. To learn
            more about how Google uses and protects your information, please
          ...
          <div className="flex flex-col justify-center ">
            ...
            <ul className="list-disc list-inside ml-3">
              ...
              <li className="flex flex-col justify-center">
                ...
                Users can object to the processing of their personal information
              ...
              <li className="flex flex-col justify-center">
                ...
                Users have the right not to be subject to decisions based solely
                on automated processing, including profiling, which produce
          ...
          <div className="flex flex-col justify-center ">
            ...
            become aware of any personal information collected from a child, we
            will promptly take steps to delete it.
          </div>
          <div className="flex flex-col justify-center ">
            <span className="text-xl pspan">
            ...
            time. Any changes to the Privacy Policy will be posted on this page
